...
public class BlurUtil {
    ...
    public static class BlurBuilder{
        ...
        public BlurBuilder setRadius(float radius){
            blurUtil.radius = radius;
            return this;
        }

        public BlurBuilder setCanReuseInBitmap(boolean canReuseInBitmap){
            blurUtil.canReuseInBitmap = canReuseInBitmap;
            return this;
        }
